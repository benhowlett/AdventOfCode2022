...
sand_coming_to_rest = True
current_x = 500
current_y = 0

while sand_coming_to_rest:
    # print(current_x, current_y)
    if current_y == len(scan.grid)-1:
        sand_coming_to_rest = False
    elif scan.get_location_type(current_x, current_y + 1) == LocationType.AIR:
        current_y += 1
